...
<head>
    ...
    <link rel="stylesheet" href="../css/user_register_view.css">
...
<body onload="openPopup()">
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="../action/user_login_user_action.php" method="POST" name="signUpForm" id="signUpForm">
        ...
        <div class="form-container sign-in">
            <form action="../action/user_login_user_action.php" method="POST" name="loginForm" id="loginForm">
                <div class="containerrr">
                    <img src="../img/user.png" alt="Login Image" style="width: 60%; max-width: 400px; height: auto;">
                
                    <div class="popup" id="popup">
                        <img src="../img/user_login.jpg">
                        <h3>!Restricted Access Alert</h3>
                        <span style="font-size:15px;">Except for the <b style="color:green">students</b> <b style="color:#0056b3">enrolled</b> in this class</span>
                        <button type="button" onclick="closePopup()" style="color:beige; background-color:green;">OK</button>
                    </div>
                </div>
